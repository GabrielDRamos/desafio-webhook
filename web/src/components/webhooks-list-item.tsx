        ...
        <div className="group rounded-lg transition-colors duration-150 hover:bg-zinc-700/30" >
            ...
            <CheckBox />   
                <Link to="/webhooks/$id" params={{ id: webhook.id }} className="flex flex-1 min-w-0 items-start gap-3">
                    <span className="w-12 shrink-0 font-mono text-xs font-semibold text-right">{webhook.method}</span>
                    <div className="flex-1 min-w-0">
                        <p className="trauncate text-xs text-zinc-200 leading-tight font-mono">
                            {webhook.pathname}
                        </p>
